...
@section('content')
            ...
            <x-adminlte-datatable id="table1" :heads="$heads" :config="$config">
                @foreach ($roles as $rol)
                    <tr>
                        ...
                        <td>{{ $rol->name }}</td>
                        <td>
                            <a href="{{ route('roles.edit', $rol) }}" class="btn btn-xs btn-default text-primary mx-1 shadow"
                                title="Edit">
    ...
    {{-- Themed --}}
    <x-adminlte-modal id="modalPurple" title="Nuevo Rol" theme="primary" icon="fas fa-users-cog" size='lg' disable-animations>
